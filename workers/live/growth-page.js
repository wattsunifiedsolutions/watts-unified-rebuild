...
<body>
  ...
  <main id="main">
    <section class="hero" aria-labelledby="growth-title">
      <img src="${HERO_PATH}" alt="Premium boardroom prepared for a private growth and opportunity conversation" width="1408" height="768" fetchpriority="high" decoding="async">
