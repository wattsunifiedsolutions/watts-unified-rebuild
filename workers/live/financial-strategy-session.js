...
<body>
  ...
  <main>
    <section class="hero" aria-labelledby="strategy-title">
      <img src="${HERO_PATH}" alt="Bright private office prepared for a focused financial strategy conversation" width="1408" height="768" fetchpriority="high" decoding="async">
