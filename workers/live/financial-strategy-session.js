const PAGE_PATHS = new Set(["/financial-strategy-session", "/financial-strategy-session/"]);
const HERO_PATH = "/assets/financial-strategy-session-hero.webp";
const HERO_URL = `${HERO_PATH}?v=20260721-hero2`;
const HERO_KEY = "financial-strategy-session-hero.webp";
const CALENDAR_URL = "https://calendar.google.com/calendar/appointments/schedules/AcZssZ0lseR7Aby6nJ6CKEqfSD-Dl9-9ZhzjpupzdIBN5iTWWYTBzFuPCvE9a7R4nRQs2DpgdEyoN8o4?gv=true";
...
<head>
  ...
  <title>Financial Strategy Session | Watts Unified Solutions</title>
  <meta name="description" content="Schedule a private Financial Strategy Session with S. Alex Watts to discuss protection, retirement, wealth, and legacy priorities.">
  <meta name="robots" content="index,follow,max-image-preview:large">
  <link rel="canonical" href="https://wattsunified.com/financial-strategy-session">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Financial Strategy Session | Watts Unified Solutions">
  <meta property="og:description" content="Choose a convenient time for a private, one-on-one financial strategy conversation.">
  <meta property="og:url" content="https://wattsunified.com/financial-strategy-session">
  <meta property="og:image" content="https://wattsunified.com${HERO_URL}">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Financial Strategy Session | Watts Unified Solutions">
  <meta name="twitter:description" content="Schedule a private conversation focused on your financial priorities and practical next steps.">
  ...
  <style>
    :root{--navy:#0b1f3a;--gold:#d4af37;--gold-deep:#9b6b17;--ink:#292929;--muted:#5d6672;--line:#e2e4e7;--cream:#faf9f6;--soft:#f6f8fa;--white:#fff;--max:1180px;--shadow:0 16px 42px rgba(23,35,50,.1)}
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#fff;color:var(--ink);font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;line-height:1.6;-webkit-font-smoothing:antialiased}body:before{content:"";position:absolute;inset:0 0 auto;height:4px;z-index:100;background:#c8992e}a{color:inherit}img{display:block;max-width:100%;height:auto}button,a{-webkit-tap-highlight-color:transparent}:focus-visible{outline:3px solid var(--gold);outline-offset:3px}.skip{position:fixed;left:14px;top:-100px;z-index:1000;padding:10px 16px;border-radius:4px;background:var(--navy);color:#fff}.skip:focus{top:14px}
    ...
    .hero{position:relative;isolation:isolate;min-height:465px;display:flex;align-items:flex-start;justify-content:center;overflow:hidden;background:#f4f4f2;text-align:center}.hero>img{position:absolute;z-index:0;inset:0;width:100%;height:100%;object-fit:cover;object-position:center center}.hero-copy{position:relative;z-index:1;width:min(900px,calc(100% - 36px));padding:72px 18px 90px}.eyebrow{display:block;margin:0 0 14px;color:#a87816;font-size:.72rem;font-weight:900;letter-spacing:.18em;text-transform:uppercase;text-shadow:0 1px 4px rgba(255,255,255,.95)}.hero h1{max-width:850px;margin:0 auto 24px;color:#111;font-family:Georgia,"Times New Roman",serif;font-size:clamp(3rem,6vw,5rem);line-height:1;letter-spacing:-.035em;text-shadow:0 2px 8px rgba(255,255,255,.92)}.hero p{max-width:710px;margin:0 auto;color:#172231;font-size:clamp(1rem,1.7vw,1.18rem);font-weight:650;line-height:1.55;text-shadow:0 1px 5px rgba(255,255,255,.95)}.hero-cta{display:inline-flex;min-height:50px;align-items:center;justify-content:center;margin-top:28px;padding:12px 24px;border:2px solid var(--gold);border-radius:3px;background:var(--gold);color:var(--navy);font-size:.86rem;font-weight:900;letter-spacing:.04em;text-decoration:none;text-transform:uppercase;box-shadow:0 8px 22px rgba(95,74,20,.16)}.hero-cta:hover{background:#e1bd44;transform:translateY(-2px)}
...
<body>
  ...
  <header class="site-header">
    <div class="header-inner">
      ...
      <nav class="site-nav" id="site-nav" aria-label="Primary navigation"><a href="/">Home</a><a href="/solutions/">Solutions</a><a href="/solutions/programs/veterans">Veteran Summit</a><a href="/opportunity">Opportunity</a><a href="/resources">Resources</a><a href="/about">About</a><a class="nav-cta" href="/schedule">Let&#39;s Connect</a></nav>
    </div>
  </header>
  <main>
    <section class="hero" aria-labelledby="strategy-title">
      <img src="${HERO_URL}" alt="Bright private office prepared for a focused financial strategy conversation" width="1408" height="768" fetchpriority="high" decoding="async">
      <div class="hero-copy"><span class="eyebrow">Watts Unified Solutions | Strategy</span><h1 id="strategy-title">Financial Strategy Session</h1><p>Select a convenient time for a one-on-one conversation. We will meet virtually at your selected time.</p><a class="hero-cta" href="#book">Choose My Time</a></div>
    </section>
    <section class="expectations" aria-label="Session expectations">
      <div class="expectations-inner">
        <div class="expectation"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M20 11a8 8 0 1 1-3-6.2"></path><path d="M20 4v7h-7"></path></svg><div><b>Clear Priorities</b><span>Focus on what deserves attention now.</span></div></div>
        <div class="expectation"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="12" r="9"></circle><path d="M12 7v5l3 2"></path></svg><div><b>60 Minutes</b><span>A focused virtual conversation.</span></div></div>
        <div class="expectation"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M6 11V8a6 6 0 0 1 12 0v3"></path><rect x="4" y="11" width="16" height="10" rx="2"></rect></svg><div><b>Private &amp; Confidential</b><span>No-pressure guidance and clear next steps.</span></div></div>
      </div>
    </section>
    <section class="booking-section" id="book" aria-labelledby="booking-title">
      <div class="booking-intro"><h2 id="booking-title">Choose a Time That Works for You</h2><p>Select an open appointment below to reserve your private virtual session.</p></div>
      <div class="booking-shell"><div class="booking-frame"><iframe src="${CALENDAR_URL}" width="100%" height="750" title="Schedule Financial Strategy Session" loading="eager"></iframe></div></div>
      ...
      <p class="booking-note">This session is educational and informational. It does not provide tax or legal advice, and no financial outcome is guaranteed. Product recommendations, if any, depend on eligibility, suitability, and applicable requirements.</p>
    </section>
  </main>
...
export default {
  async fetch(request, env = {}) {
    ...
    if (url.pathname === HERO_PATH) {
      const body = env.SCHEDULE_ASSETS?.get ? await env.SCHEDULE_ASSETS.get(HERO_KEY, "arrayBuffer") : env.FINANCIAL_STRATEGY_HERO;
      ...
      return new Response(request.method === "HEAD" ? null : body, { headers: {
        ...
        "x-watts-financial-strategy": "highlevel-conversion-v1",
      }});
    }
    if (!PAGE_PATHS.has(url.pathname)) return Response.redirect("https://wattsunified.com/financial-strategy-session", 302);
