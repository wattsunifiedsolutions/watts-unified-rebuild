...
- Homepage navigation Worker deployment: `49b393dfc7b54e7fb39214c12d5dd245`
...
- The main `/schedule` Let’s Connect page now uses conversion hero release `20260721-connect-hero2`: a bright, people-free private appointment setting with an open planner, phone, clock, navy-and-gold pen, and prepared chairs. The 1672×941 WebP is 85 KB, stored in deployment-owned KV under `lets-connect-hero-v2.webp`, served through a versioned immutable first-party URL, preloaded for LCP, and positioned behind the existing copy without an overlay or gradient. Mobile displays the image at a stable 16:9 ratio above the copy, with no horizontal overflow; the message form, schedule switcher, header, footer, and calendar behavior remain unchanged.
